    ...
    for col in df.columns:
        if col != target_column:  # Exclude target column
            ...
            for value in unique_values:
                ...
                try:
                    numeric_value = float(value)  # Try to convert to float
                except ValueError:
                    print(f"Value '{value}' is not numeric, skipping adjustment.")
                ...
                if len(classes) > 1:
                    ...
                    for idx, class_id in enumerate(classes):
                        if idx == 0:
                            ...
                            new_value = numeric_value + 0.001 * idx  # Ensure it's different from the original
...
output_csv_file = 'final.csv'  # Name of the output CSV file
